...
impl Object {
    ...
    pub fn take_damage(&mut self, damage: i32) {
        ...
        // check for deaths, call death function
...
fn move_towards(id: usize, target_x: i32, target_y: i32, map: &Map, objects: &mut [Object]) {
    ...
    // normalize to 1, round it and convert to int
...
// combat-related props and methods (monsters, player, npcs)
...
fn make_map(objects: &mut Vec<Object>) -> Map {
    ...
    for _ in 0..MAX_ROOMS {
        ...
        // random pos without going out of the boundaries of map
        ...
        if !failed {
            ...
            if rooms.is_empty() {
                // this is first room. player goes here
                objects[PLAYER].set_pos(new_x, new_y);
            } else {
                // all rooms except first one
                // connect with previous via tunnel
...
fn render_all(tcod: &mut Tcod, game: &mut Game, objects: &[Object], fov_recompute: bool) {
    ...
    // go through all the tiles and set the colour
...
fn main() {
    ...
    // force fov recompute first loop
